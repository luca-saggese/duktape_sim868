...
#define SPI_CS_PIN EAT_PIN5_UART1_DCD
#define MCP2515_SELECT()   eat_gpio_write(SPI_CS_PIN, EAT_GPIO_LEVEL_LOW)
#define MCP2515_UNSELECT() eat_gpio_write(SPI_CS_PIN, EAT_GPIO_LEVEL_HIGH)
