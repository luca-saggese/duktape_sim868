...
*  Others Fail
* NOTE
*   The GPT timer is a hardware timer, don't execute blocking function in the callback function 
*   such as sleep, get semaphores, allocation memory and so on , and execution time as far as possible short.
*****************************************************************************/
...
* NOTE: 
*    This is a software watchdog. If the kernel ASSERT fail, then the watchdog will fail.
*****************************************************************************/
