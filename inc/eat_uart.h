...
/*****************************************************************************
* Function :   eat_uart_power_off
* Description: Turn off UART internal power supply, so that RX and TX are low level.
* Parameters :
* Returns:
*     EAT_TRUE if success, otherwise EAT_FALSE.
* NOTE:
*   eat_uart_open will turnon power automatically.
*
*   The following conditions must be established to set up successfully.
*     1. The UART is not AT port or DEBUG port.
*     2. The UART is not opened.
*****************************************************************************/
extern eat_bool (*const eat_uart_power_off)(EatUart_enum uart);
